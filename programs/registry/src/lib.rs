...
pub mod registry {
    ...
    pub fn instance_registry(ctx: Context<InstanceRegistry>, instance: u64) -> Result<()> {
        ...
        let register_registry_ctx = CpiContext::new_with_signer(core_ds, accounts, signer_seeds);
    ...
    pub fn register_action_bundle(ctx: Context<RegisterSystem>) -> Result<()> {
        ...
        ctx.accounts
            ...
            .instances
            .insert(ctx.accounts.registry_instance.instance);
        ctx.accounts.action_bundle_registration.can_mint = true;
        Ok(())
    }

    pub fn add_components_to_action_bundle_registration(
        ctx: Context<AddComponentsToActionBundleRegistration>,
    ...
    pub fn add_instances_to_action_bundle_registration(
        ctx: Context<AddInstancesToActionBundleRegistration>,
        instances: Vec<u64>,
    ) -> Result<()> {
    ...
    pub fn init_entity(
        ctx: Context<InitEntity>,
        entity_id: u64,
        components: BTreeMap<Pubkey, SerializedComponent>,
    ) -> Result<()> {
    ...
    pub fn req_add_component(
        ctx: Context<AddComponents>,
        components: Vec<(Pubkey, SerializedComponent)>,
    ) -> Result<()> {
    ...
    pub fn req_remove_component(
        ctx: Context<RemoveComponent>,
        components: Vec<Pubkey>,
    ) -> Result<()> {
    ...
    pub fn req_modify_component(
        ctx: Context<ModifyComponent>,
        components: Vec<(Pubkey, Vec<u8>)>,
    ) -> Result<()> {
